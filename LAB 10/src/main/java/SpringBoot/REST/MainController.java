...
public class MainController
{
    ...
    public void refreshList() {
        ...
        if(listOfFiles!=null) ///////////////////////////////// warto dodać
        {
    ...
    @ResponseBody
    public Result deleteImage(@RequestParam String action, @PathVariable(value = "index") int index) {
    ...
    public ModelAndView getFile() throws IOException {
            InputStream is=null;
            List<MyImage> testList=new ArrayList<MyImage>();
